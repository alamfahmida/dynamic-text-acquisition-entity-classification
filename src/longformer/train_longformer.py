...
def main(args):
    ...
    output_dir = f"models/longformer/{dataset}"
    os.makedirs(output_dir, exist_ok=True)

    tokenizer = LongformerTokenizer.from_pretrained("allenai/longformer-base-4096")

    train_encodings, train_labels = load_and_prepare_data(dataset, "train", tokenizer, max_length=1024)
    dev_encodings, dev_labels = load_and_prepare_data(dataset, "dev", tokenizer, max_length=1024)
